...
-   $\hat{\beta}_j$ is the [amount of increase in the average response]{style="color:blue;"} by a 1 unit increase in the $j$-th predictor $X_{ij}$, *when all other predictors are fixed to an arbitrary value*.
...
Now, let's set the predictors and response. In the definition of `X_full`, the double bracket in `[]` is important because it allows us to have a pandas DataFrame as output. This makes it easier to fit the linear regression model with **scikit-learn**.
...
::: {style="font-size: 90%;"}
-   The average sales are 3.258 thousands of dollars when the [advertising budgets]{style="color:darkgreen;"} for TV, Radio, and Newspaper [are 0 dollars]{style="color:darkgreen;"}.

-   Increasing the advertising TV by 1 hundreds of dollars [increases the average sales]{style="color:darkblue;"} by 0.046 thousands of dollars.

-   Increasing the advertising Radio by 1 hundreds of dollars [increases the average sales]{style="color:darkblue;"} by 0.186 thousands of dollars.

-   Increasing the advertising Newspaper by 1 hundreds of dollars [reduces the average sales]{style="color:darkred;"} by 0.005 thousands of dollars.\
:::
