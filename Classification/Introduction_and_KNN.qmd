...
1.  Select the *K* nearest neighbors to the observation $\boldsymbol{x}$.
2.  $\hat{p}_1(\boldsymbol{x})$ is the proportion of *K* nearest neighbors that belong to class 1. $\hat{p}_0(\boldsymbol{x})$ is the proportion of *K* nearest neighbors that belong to class 0.
